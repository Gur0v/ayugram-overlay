...
PATCHES=(
    ...
    # Fix build against PipeWire >= 1.2: spa_pod_object_find_prop and
    # spa_pod_get_values were removed from the public SPA API.
    "${FILESDIR}/tg_owt-0_pre20250515-pipewire-spa-compat.patch"
)
